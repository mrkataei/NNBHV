...
"""
from old.Libraries.patterns import *
from old.Interfaces import Strategy


def _get_ohcl(candle_sticks):
    c_open = candle_sticks[['open', 'open1', 'open2', 'open3', 'open4']].to_numpy()
    c_high = candle_sticks[['high', 'high1', 'high2', 'high3', 'high4']].to_numpy()
    c_close = candle_sticks[['close', 'close1', 'close2', 'close3', 'close4']].to_numpy()
    c_low = candle_sticks[['low', 'low1', 'low2', 'low3', 'low4']].to_numpy()
